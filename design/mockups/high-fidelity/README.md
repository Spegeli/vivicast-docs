...
Dieses Verzeichnis beschreibt die aktuelle hochwertige visuelle Zielrichtung von Vivicast.
...
Aktuelle High-Fidelity-Renderings liegen direkt unter:

```text
rendered/
```

Es gibt keinen aktiven Low-Fidelity-Zweig mehr und keinen aktiven Render-Archivordner.

## Aktive Umsetzungsquellen

```text
02-ui-direction-decisions.md
rendered/
design/design-system/compose-template/VIVICAST-VISUAL-IMPLEMENTATION-SPEC-v2.md
design/design-system/compose-template/*.kt
```
